...
| -------------- | --------------- | ----------- | -------- |
 ...
 | [get-installed-path@^2.0.3](https://www.npmjs.com/package/get-installed-path) | Get installation path where the given package is installed. Works for globally and locally installed packages. Works on Windows too. | 2.0.3 | production | 
